...
our $sSEPARATOR_STR1 = "#1#";   # -created: ELu
our $sSEPARATOR_STR2 = "#2#";   # -created: ELu 
our $sSEPARATOR_STR3 = "#3#";   # -created: ELu
our $sSEPARATOR_STR4 = ":";   # -created: ELu 
our $sSEPARATOR_STR5 = "#5#";   # -created: ELu     
        ...
        # ack -c
            ...
            if ( !$opt_l || $matches_for_this_file > 0) {
                if ( $opt_show_filename ) {
                    App::Ack::say( $file->name, $sSEPARATOR_STR1, $matches_for_this_file );
                }
                else {
...
sub get_file_id {
    ...
    if ( $App::Ack::is_windows ) {
        ...
        if ( my ( $dev, $inode ) = (stat($filename))[0, 1] ) {
            return join($sSEPARATOR_STR2, $dev, $inode);
        }
        else {
    ...
    if ( $is_tracking_context ) {
        ...
        while ( <$fh> ) {
            ...
            if ( $in_range && ($opt_v xor /$search_re/o) ) {
                ...
                print_line_with_options( $filename, $_, $., $sSEPARATOR_STR3, 1 );
                $has_printed_for_this_file = 1;
            }
        ...
        while ( <$fh> ) {
            ...
            if ( $in_range ) {
                ...
                if ( /$search_re/o ) {
                    ...
                    s/[\r\n]+$//;
                    print_line_with_options( $filename, $_, $., $sSEPARATOR_STR4 ); # -obs: console output
                    $has_printed_for_this_file = 1;
                    $nmatches++;
                    $max_count--;
                    $last_match_lineno = $.;
...
sub print_line_with_options {  # -obs: console output
...
sub print_line_with_context {
    ...
    print_line_with_options( $filename, $matching_line, $lineno, $sSEPARATOR_STR5);
